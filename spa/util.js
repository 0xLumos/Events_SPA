...
export function getDimensions(width, height, maxSize) {
...
export function getThumbnailDataURL(data, mimetype) {
	const img = document.createElement('img')
	img.src = data
	const canvas = document.createElement('canvas')
	const context = canvas.getContext('2d')
	const { width, height } = getDimensions(img.width, img.height, 200)
	canvas.width = width
